...
const keywordOptions = [
  ...
  {title: 'Flood Management', value: 'Flood Management'},
  {title: 'Nature Development', value: 'Nature Development'},
  {title: 'Object-based Solutions', value: 'Object-based Solutions'},
  {title: 'Purification', value: 'Purification'},
  {title: 'Recreation', value: 'Recreation'},
]

const tagOptions = [
  { title: 'Agriculture', value: 'Agriculture' },
  { title: 'Artificial Reefs', value: 'Artificial Reefs' },
  { title: 'Awareness', value: 'Awareness' },
  { title: 'Aquatic Ecosystems', value: 'Aquatic Ecosystems' },
  { title: 'Biodiversity Enhancement', value: 'Biodiversity Enhancement' },
  { title: 'Bioremediation', value: 'Bioremediation' },
  { title: 'Blue Infrastructure', value: 'Blue Infrastructure' },
  { title: 'Citizen Participation', value: 'Citizen Participation' },
  { title: 'Clean Drinking Water', value: 'Clean Drinking Water' },
  { title: 'Climate Adaptation', value: 'Climate Adaptation' },
  { title: 'Coastal Protection', value: 'Coastal Protection' },
  { title: 'Coastal Resilience', value: 'Coastal Resilience' },
  { title: 'Ecological Corridors', value: 'Ecological Corridors' },
  { title: 'Ecology', value: 'Ecology' },
  { title: 'Ecology Restoration', value: 'Ecology Restoration' },
  { title: 'Energy Consumption Reduction', value: 'Energy Consumption Reduction' },
  { title: 'Fauna', value: 'Fauna' },
  { title: 'Filtering Gardens', value: 'Filtering Gardens' },
  { title: 'Fishing Dams', value: 'Fishing Dams' },
  { title: 'Floating Garden', value: 'Floating Garden' },
  { title: 'Flood Management', value: 'Flood Management' },
  { title: 'Green Infrastructure', value: 'Green Infrastructure' },
  { title: 'Habitat Creation', value: 'Habitat Creation' },
  { title: 'Habitat Restoration', value: 'Habitat Restoration' },
  { title: 'Heat-Island Mitigation', value: 'Heat-Island Mitigation' },
  { title: 'Irrigation', value: 'Irrigation' },
  { title: 'Indigenous', value: 'Indigenous' },
  { title: 'Infrastructure', value: 'Infrastructure' },
  { title: 'Nature-Based Solutions', value: 'Nature-Based Solutions' },
  { title: 'Photosynthesis', value: 'Photosynthesis' },
  { title: 'Pollution', value: 'Pollution' },
  { title: 'Purification', value: 'Purification' },
  { title: 'Public Space Development', value: 'Public Space Development' },
  { title: 'Rainwater Collection', value: 'Rainwater Collection' },
  { title: 'Recreation', value: 'Recreation' },
  { title: 'Renovation', value: 'Renovation' },
  { title: 'Research', value: 'Research' },
  { title: 'River', value: 'River' },
  { title: 'River Restoration', value: 'River Restoration' },
  { title: 'Sewer System', value: 'Sewer System' },
  { title: 'Soil Treatment', value: 'Soil Treatment' },
  { title: 'Species Preservation', value: 'Species Preservation' },
  { title: 'Stormwater Management', value: 'Stormwater Management' },
  { title: 'Sustainable Development', value: 'Sustainable Development' },
  { title: 'Urban Renewal', value: 'Urban Renewal' },
  { title: 'Urban River Systems', value: 'Urban River Systems' },
  { title: 'Water Consumption Reduction', value: 'Water Consumption Reduction' },
  { title: 'Water Park', value: 'Water Park' },
  { title: 'Water Purification', value: 'Water Purification' },
  { title: 'Water Reclamation', value: 'Water Reclamation' },
  { title: 'Water Treatment', value: 'Water Treatment' },
  { title: 'Wetland Restoration', value: 'Wetland Restoration' },
];

const contextOptions = [
  {title: 'City', value: 'City'},
  {title: 'Landscape', value: 'Landscape'},
  {title: 'Peripheral', value: 'Peripheral'}
]

const targetOptions = [
  {title: 'Drainage', value: 'Drainage'},
  {title: 'Healthy surface water', value: 'Healthy surface water'},
  {title: "Kwel tegenhouden'", value: "Kwel tegenhouden'"},
  {title: 'Local infiltration', value: 'Local infiltration'},
  {title: 'Local storage', value: 'Local storage'},
  {title: 'Management', value: 'Management'},
  {title: 'Seasonal water retention', value: 'Seasonal water retention'}
]

const measurementOptions = [
  { "title": "Blackwater Management", "value": "Blackwater Management" },
  { "title": "Cultivation", "value": "Cultivation" },
  { "title": "Drainage", "value": "Drainage" },
  { "title": "Drought Prevention", "value": "Drought Prevention" },
  { "title": "Energy Production", "value": "Energy Production" },
  { "title": "Flood Management", "value": "Flood Management" },
  { "title": "Flood Prevention", "value": "Flood Prevention" },
  { "title": "Nature Development", "value": "Nature Development" },
  { "title": "New Ecosystem", "value": "New Ecosystem" },
  { "title": "Purify Water", "value": "Purify Water" },
  { "title": "Recreation", "value": "Recreation" },
...
export const projectType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'Target details for the research',
    }),
    defineField({
      name: 'measurements',
      title: 'Measurements',
      type: 'array',
      description: 'Measurement details associated with the research',
      of: [
        {
          type: 'string',
        }
